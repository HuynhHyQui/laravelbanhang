                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-category-product')}}">All Category</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-brand-product')}}">All Brand</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-banner')}}">New Banner</a></li>
                                <li><a href="{{URL::to('/manage-banner')}}">All Banner</a></li>
                            </ul>
                        </li>
